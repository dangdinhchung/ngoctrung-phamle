(function () {
    ...
    function postToGoogleForms(data) {
        const formURL = "https://docs.google.com/forms/u/0/d/e/1FAIpQLSfLIHz1DlCVu-XikYpQ-WEYFIikR4zxkBAdSnL288sq77KSwA/formResponse";
        const formData = new FormData();
        formData.append('entry.407840247', data.name); // Họ tên
        formData.append('entry.871607498', data.phone); // Số điện thoại
        formData.append('entry.551490595', data.content); // Lời chúc
